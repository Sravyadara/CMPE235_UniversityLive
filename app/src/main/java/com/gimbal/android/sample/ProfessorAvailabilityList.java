...
public class ProfessorAvailabilityList extends BaseAdapter {
...
//This class extends the BaseAdapter and overrides getView() method to implement custom listview.
    ...
    public ProfessorAvailabilityList(Context context, ArrayList<AppointmentDetails> results) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.txt_Available = (TextView) convertView.findViewById(R.id.ListcourseName);
        ...
        holder.txt_Available.setText(itemDetailsrrayList.get(position).getCourseName());
